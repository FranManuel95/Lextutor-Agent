...
export default function QuizPage() {
    ...
    return (
        <div className="min-h-screen bg-gem-onyx text-gem-offwhite font-sans p-8 flex flex-col">
            <div className="max-w-4xl mx-auto w-full flex-1">
                ...
                {step === 'taking' && (
                    <div className="space-y-8">
                        ...
                        <div className="sticky bottom-4 bg-gem-onyx/90 backdrop-blur p-4 border-t border-law-accent/20 rounded-t-xl flex justify-between items-center">
