    ...
    return (
        <div className="p-8 space-y-8">
            <div className="flex flex-col gap-2">
                <h2 className="text-3xl font-serif text-law-gold italic">Gestión de Usuarios</h2>
                <p className="text-gem-offwhite/60">
                    Listado de todos los usuarios registrados en la plataforma.
                </p>
            </div>

            <Card className="bg-gem-slate border-law-accent/20">
                <CardHeader>
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                                ...
                                <TableRow key={user.id} className="border-law-accent/10 hover:bg-white/5">
                                    <TableCell className="font-medium text-gem-offwhite">
                                        <div className="flex items-center gap-3">
                                            <Avatar className="h-8 w-8 border border-law-accent/30">
                                                ...
                                                <AvatarFallback className="bg-law-primary text-law-gold text-xs">
                                    ...
                                    <TableCell>
                                        <Badge variant={user.role === "admin" ? "default" : "secondary"}
                                            className={user.role === "admin" ? "bg-law-gold text-law-primary hover:bg-law-gold/80" : "bg-white/10 text-white hover:bg-white/20"}>
                                            {user.role || "user"}
                                        </Badge>
                                    </TableCell>
                            ...
                            {!users.length && (
                                <TableRow>
                                    <TableCell colSpan={4} className="text-center py-8 text-gem-offwhite/50">
